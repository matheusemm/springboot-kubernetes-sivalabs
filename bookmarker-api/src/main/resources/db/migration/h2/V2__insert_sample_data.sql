...
VALUES ('How To Remove Docker Containers, Images, Volumes, and Networks',
       ...
       ('All You Need To Know About Unit Testing with Spring Boot',
        'https://reflectoring.io/unit-testing-spring-boot', CURRENT_TIMESTAMP()),
       ('Spring Boot Security Jwt Authentication',
        'https://www.devglan.com/spring-security/spring-boot-jwt-auth', CURRENT_TIMESTAMP()),
       ('A categorized list of all Java and JVM features since JDK 8',
        'https://advancedweb.hu/2019/02/19/post_java_8', CURRENT_TIMESTAMP()),
       ...
       ('Deserialize Immutable Objects with Jackson',
        'https://www.baeldung.com/jackson-deserialize-immutable-objects', CURRENT_TIMESTAMP()),
